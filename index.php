...
a.jqte_tool_label.unselectable {
    ...
    <body id="page-top">
        ...
        <img class="logo-img" src="assets/img/logo.png" width="50" height="50">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2023 - <?php echo $_SESSION['system']['name'] ?> | <a href="https://purnamtech.com" target="_blank">Purnam Technology</a></div></div>
        </footer>
